...
```ts
rxNostr.req([{}], { relays: "wss://relay.example.com" });
rxNostr.req([{}], { relays: ["wss://one.example.com", "wss://two.example.com"] });
```
...
rxNostr
  .req([{}], { relays: ["wss://relay.example.com"] })

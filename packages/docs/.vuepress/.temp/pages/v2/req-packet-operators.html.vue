...
<p><code v-pre>ReqPacket[]</code> の Observable を、<code v-pre>mergeFilter</code> パラメータに基づいて <code v-pre>ReqPacket</code> の Observable に変換します。<a href="https://rxjs.dev/api/operators/bufferTime" target="_blank" rel="noopener noreferrer"><code v-pre>bufferTime()</code></a>と併用すると便利です。</p>

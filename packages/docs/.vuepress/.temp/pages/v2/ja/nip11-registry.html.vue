...
<p><RouteLink to="/v2/ja/subscribe-event.html#req-queue">REQ Queue</RouteLink> で説明した通り、rx-nostr はリレーの制約を尊重して動作するために NIP-11 に関連する情報を自動で取得します。この動作は <code v-pre>createRxNostr()</code> の <code v-pre>skipFetchNip11</code> オプションで無効にできます。</p>

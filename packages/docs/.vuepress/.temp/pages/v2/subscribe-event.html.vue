...
<p><RouteLink to="/v2/getting-started.html">Getting Started</RouteLink> ではこの流れを具体的なコードとともに説明しているので参考にしてください。</p>
...
<p>通常、リレーには同時並行できる REQ サブスクリプションの数に上限が設けられており、<a href="https://github.com/nostr-protocol/nips/blob/master/11.md" target="_blank" rel="noopener noreferrer">NIP-11</a> に基づきその上限設定が公開されます。rx-nostr はこの情報を自動で読み取って、並行数の制限を逸脱しないように REQ 要求をキューイングします。</p>
<p>詳しくは <RouteLink to="/v2/nip11-registry.html">NIP-11 Registry</RouteLink> を参照してください。</p>
</div></template>

...
<p><RouteLink to="/v2/en/getting-started.html">Getting Started</RouteLink> ではこの流れを具体的なコードとともに説明しているので参考にしてください。</p>
...
<p>詳しくは <RouteLink to="/v2/en/nip11-registry.html">NIP-11 Registry</RouteLink> を参照してください。</p>
</div></template>

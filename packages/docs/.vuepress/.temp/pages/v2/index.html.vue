...
<p>rx-nostr は <a href="https://nostr.com/" target="_blank" rel="noopener noreferrer">Nostr</a> アプリケーションがひとつまたは複数のリレーとの堅牢な通信を簡便かつ直感的に実現するためのライブラリです。rx-nostr は <a href="https://rxjs.dev/" target="_blank" rel="noopener noreferrer">RxJS</a> で実装されており、RxJS の諸機能とのシームレスな連携が可能となるよう設計されていますが、RxJS との併用は必須ではありません。</p>
<p>Nostr アプリケーションの開発者は rx-nostr を利用することで、リレー通信に伴う以下のような煩わしい問題の存在を意識せず、<a href="https://github.com/nostr-protocol/nips/blob/master/01.md" target="_blank" rel="noopener noreferrer">NIP-01</a> に基づく publish/subscribe を透過的に扱えるようになります。</p>
<ul>
...
<ul>
<li><a href="https://github.com/nostr-protocol/nips/blob/master/11.md" target="_blank" rel="noopener noreferrer">NIP-11</a> に基づいて公開されるリレーの同時 REQ サブスクリプション上限に抵触しないよう、リレーへの REQ 要求を適切にキューイングします。</li>
</ul>
</li>
<li><strong>AUTH メッセージの自動ハンドリング</strong>
<ul>
<li><a href="https://github.com/nostr-protocol/nips/blob/master/42.md" target="_blank" rel="noopener noreferrer">NIP-42</a> に基づく AUTH メッセージを自動でハンドリングします。rx-nostr を利用する場合、NIP-42 に対応するためにはオプションを設定するだけで済みます。</li>
</ul>
</li>
...
<p>rx-nostr を使うと、例えば kind1 のイベントを購読するコードは以下のように簡潔に実現できます。なお、このコードの説明は <RouteLink to="/v2/getting-started.html">Getting Started</RouteLink> で詳述します。</p>
...
<ul>
<li><a href="https://github.com/nostr-protocol/nips/blob/master/01.md" target="_blank" rel="noopener noreferrer">NIP-01 (EN)</a></li>
<li><a href="https://github.com/nostr-jp/nips-ja/blob/main/01.md" target="_blank" rel="noopener noreferrer">NIP-01 (JA)</a></li>
</ul>
</div>
</div></template>

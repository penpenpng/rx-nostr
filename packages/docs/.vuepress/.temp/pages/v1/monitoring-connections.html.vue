...
<td style="text-align:left">WebSocket がコード 4000 で終了したとき、再接続を試行せずにこの状態に遷移します。これは <a href="https://github.com/nostr-protocol/nips/blob/fab6a21a779460f696f11169ddf343b437327592/01.md?plain=1#L113" target="_blank" rel="noopener noreferrer">NIP-01 が推奨する</a>挙動です。</td>
</tr>
<tr>

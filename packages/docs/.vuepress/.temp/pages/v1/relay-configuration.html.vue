...
<p>WebSocket が予期しない理由で切断されたとき、rx-nostr は <a href="https://aws.amazon.com/jp/blogs/architecture/exponential-backoff-and-jitter/" target="_blank" rel="noopener noreferrer">exponential backoff and jitter</a> 戦略に従って自動で再接続を試みます。この挙動は <code v-pre>createRxNostr()</code> のオプションで変更できます。</p>

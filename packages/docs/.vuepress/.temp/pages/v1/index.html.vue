...
<p>rx-nostr は <a href="https://nostr.com/" target="_blank" rel="noopener noreferrer">Nostr</a> アプリケーションがリレーとより簡単に通信するための <a href="https://rxjs.dev/" target="_blank" rel="noopener noreferrer">RxJS</a> に基づくライブラリです。Nostr アプリケーションの開発者が考慮を迫られる以下のような煩わしい課題を肩代わりし、開発者がアプリケーションロジックに集中する手助けをします。</p>
<ul>
...
<p>rx-nostr を使うと、例えば kind1 のイベントを購読するコードは以下のように簡潔に実現できます。なお、これと同等のコードの説明は <RouteLink to="/v1/first-step.html">First Step</RouteLink> で詳述します。より複雑な例は <RouteLink to="/v1/examples.html">Examples</RouteLink> で見ることができます。</p>
...
<ul>
<li><a href="https://github.com/nostr-protocol/nips" target="_blank" rel="noopener noreferrer">NIPs</a> の特に <a href="https://github.com/nostr-protocol/nips/blob/master/01.md" target="_blank" rel="noopener noreferrer">NIP-01</a></li>
<li><a href="https://rxjs.dev/guide/overview" target="_blank" rel="noopener noreferrer">RxJS Introduction</a></li>
</ul>
</div>
</div></template>

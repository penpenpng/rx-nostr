...
<p>このドキュメントは rx-nostr 1.x に準じて記述されています。細かな挙動や API が 2.x のものと異なる可能性があります。</p>
</div>
...
<p>rx-nostr を使うと、例えば kind1 のイベントを購読するコードは以下のように簡潔に実現できます。なお、これと同等のコードの説明は <RouteLink to="/v1%20copy/first-step.html">First Step</RouteLink> で詳述します。より複雑な例は <RouteLink to="/v1%20copy/examples.html">Examples</RouteLink> で見ることができます。</p>
...
<ul>
<li><a href="https://github.com/nostr-protocol/nips" target="_blank" rel="noopener noreferrer">NIPs<ExternalLinkIcon/></a> の特に <a href="https://github.com/nostr-protocol/nips/blob/master/01.md" target="_blank" rel="noopener noreferrer">NIP-01<ExternalLinkIcon/></a></li>

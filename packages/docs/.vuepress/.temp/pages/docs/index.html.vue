...
<p>rx-nostr を使うと、例えば kind1 のイベントを購読するコードは以下のように簡潔に実現できます。なお、これと同等のコードの説明は <RouteLink to="/docs/first-step.html">First Step</RouteLink> で詳述します。より複雑な例は <RouteLink to="/docs/examples.html">Examples</RouteLink> で見ることができます。</p>

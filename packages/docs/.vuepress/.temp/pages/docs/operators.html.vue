...
<p>rx-nostr が提供する operator はもちろんのこと、RxJS が提供する強力な operator の力を借りることも可能です。以下はその一例です。より多くの例は <RouteLink to="/docs/examples.html">Examples</RouteLink> を参照してください。</p>

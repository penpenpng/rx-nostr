...
<p>WebSocket が予期しない理由で切断されたとき、rx-nostr は自動で再接続を試みます。この挙動は <code v-pre>createRxNostr()</code> の <code v-pre>retry</code> オプションで変更できます。デフォルトでは <a href="https://aws.amazon.com/jp/blogs/architecture/exponential-backoff-and-jitter/" target="_blank" rel="noopener noreferrer">exponential backoff and jitter<ExternalLinkIcon/></a> 戦略に従って 5 回までの再接続を試行します。</p>
...
<p>WebSocket 接続がステータスコード 4000 によって切断された場合、自動再接続は行われません。これは<a href="https://github.com/nostr-protocol/nips/commit/0ba4589550858bb86ed533f90054bfc642aa5350" target="_blank" rel="noopener noreferrer">既に廃止された古い NIP-01 仕様<ExternalLinkIcon/></a>への後方互換性のためです。</p>
</div>

...
<p>デフォルトの <code v-pre>signer</code> は <code v-pre>nip07Signer()</code> です。これはランタイムから <a href="https://github.com/nostr-protocol/nips/blob/master/07.md" target="_blank" rel="noopener noreferrer">NIP-07<ExternalLinkIcon/></a> インターフェースを探し、それを利用して必要な値を計算します。</p>
</div>
